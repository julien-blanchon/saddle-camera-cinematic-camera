function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./saddle-camera-cinematic-camera-example-moving-target_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('saddle-camera-cinematic-camera-example-moving-target_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
